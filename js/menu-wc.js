...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">vai-dar-bom-plataforma-estudos documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-063f7cba6f1e64b060ebc0b75955b67b"' : 'data-target="#xs-components-links-module-AppModule-063f7cba6f1e64b060ebc0b75955b67b"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-063f7cba6f1e64b060ebc0b75955b67b"' :
                                            'id="xs-components-links-module-AppModule-063f7cba6f1e64b060ebc0b75955b67b"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/FormulariosComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">FormulariosComponent</a>
                                            </li>
                                            <li class="link">
